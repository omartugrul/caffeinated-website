      ...
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/caffeinatedhtx/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/30 hover:text-white/60 transition-colors">
            ...
            {/* TikTok hidden until account is created */}
          </div>
